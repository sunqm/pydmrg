...
class DMRGEnv(object):
    def __init__(self, **keywords):
        ...
        self.sys_add = 1
        self.tot_sites = 1
        self.tot_sym = 'c1' # need interface to IrrepSpace
        self.nelec = -1
        self.spin = -1
        self.sweep_iter_schedule   = [0   ]  # these lists
        self.sweep_state_schedule  = [2   ]  #  ...
        self.sweep_qstate_schedule = [0   ]  #  ...
        self.davidson_tol_schedule = [1e-5]  #  ...
        self.noise_schedule        = [1e-5]  #  ...
        self.additional_noise      = [0.  ]  # should have same lenth
        self.maxM = 10000
...
#        self.molecule_quantum = None
    ...
    def sweep_schedule(self, sweep_iter):
        ...
        return self.sweep_state_schedule[i], self.sweep_state_schedule[i_ls], \
                self.sweep_qstate_schedule[i], self.davidson_tol_schedule[i], \
                self.noise_schedule[i], self.additional_noise[i]
    ...
    def max_block_cycle(self, sweep_iter=0):
        n_iters = (self.tot_sites - 2*self.forward_starting_size \
                ...
                + 1
        print 'max_block_cyc', self.tot_sites, \
                self.forward_starting_size, \
                self.sys_add, self.env_add(sweep_iter), n_iters
        return n_iters
